...
export interface components {
  schemas: {
    ...
    Is: {
      ...
      value: Record<string, never>
    } & Omit<components['schemas']['EqualityAuthorMatch'], 'operator'> &
      Omit<components['schemas']['EqualityString'], 'operator'> &
      Omit<components['schemas']['EqualityNullableString'], 'operator'> &
      Omit<components['schemas']['EqualityReadStatus'], 'operator'> &
      Omit<components['schemas']['EqualityStatus'], 'operator'> &
      Omit<components['schemas']['StringOp'], 'operator'> &
      Omit<components['schemas']['EqualityMediaProfile'], 'operator'> &
      Omit<components['schemas']['NumericFloat'], 'operator'> &
      Omit<components['schemas']['EqualityPosterMatch'], 'operator'>)
    IsFalse: {
      operator: 'IsFalse'
