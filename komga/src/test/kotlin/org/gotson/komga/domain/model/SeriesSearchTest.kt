    ...
    val search =
      SeriesSearch(
        SearchCondition.AllOfSeries(
          ...
          SearchCondition.SharingLabel(SearchOperator.IsNullT()),
          SearchCondition.SharingLabel(SearchOperator.IsNotNullT()),
          ...
          SearchCondition.Genre(SearchOperator.IsNullT()),
          SearchCondition.Genre(SearchOperator.IsNotNullT()),
